...
and :ref:`the protocol-specific part<shell_proto_revisit_mumbai>`.
...
- fixed protocol constants are defined in the module
  ...
  <tezos-protocol-016-PtMumbai/Trp_016_PtMumbai/Constants_repr/index.html>`
- parametric constants are defined in the module
  :package-api:`Constants_parametric_repr
  <tezos-protocol-016-PtMumbai/Trp_016_PtMumbai/Constants_parametric_repr/index.html>`
...
- :ref:`proof-of-stake parameters <ps_constants_mumbai>`.
- :ref:`consensus-related parameters <cs_constants_mumbai>`
- :ref:`randomness generation parameters <rg_constants_mumbai>`.
