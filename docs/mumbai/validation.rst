...
modes<validation_modes_mumbai>`. For example, these modes enable the
...
<tpe/Tezos_protocol_environment/V8/module-type-T/Updater/module-type-PROTOCOL/index.html>`
module in the :doc:`protocol
environment<../shell/protocol_environment>` ``V8``, and it is
implemented by this protocol in the
:package-api:`Main<tp-016/Tezos_raw_protocol_016_PtMumbai/Main/index.html>`
module.
...
:ref:`operation_validity_mumbai` further below, the whole block is
...
constitute a sufficiently large :ref:`quorum<quorum_mumbai>`. That is,
...
block (see :ref:`partial_application_mumbai` above). This feature
...
:ref:`Manager operation<manager_operations_mumbai>` are a class of
...
A :ref:`batch<manager_operations_batches_mumbai>` of manager operations
